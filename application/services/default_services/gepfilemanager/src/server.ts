...
class App {
    ...
    private DatabaseCredentials() {
        ...
        SCMconfig.SCMData( async result => {
            this.DB_Url = result.data.DB_URL_reactscreentest_2983;
            let db_auth = result.data.DB_AUTH_reactscreentest_2983;
            let db_coll = result.data.DB_COLL_reactscreentest_2983;
